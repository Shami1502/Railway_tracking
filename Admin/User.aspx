...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		...
		<data:EntityGridView ID="GridView1" runat="server"			
			...
			<Columns>
				...
				<asp:BoundField DataField="UserName" HeaderText="User Name" SortExpression="[User_Name]"  />
				<asp:BoundField DataField="UserPhone" HeaderText="User Phone" SortExpression="[User_Phone]"  />
				<asp:BoundField DataField="EmailAddress" HeaderText="Email Address" SortExpression="[Email_Address]"  />
				<asp:BoundField DataField="UserPassword" HeaderText="User Password" SortExpression="[User_Password]"  />
